...
class JsonHelper {
     ...
     * @since 0.1.0
     */
    public static function var_to_boolean($var,$b_null_is_good = false) {
	 ...
	 */
    public static function dataToString( string $data_type, $what) {
        //var_dump($data_type);
        // var_dump($what);
        switch ($data_type) {
            case 'boolean':
...
<table border=1 cellspacing=0 cellpadding=3 width=100%>";
	 ...
	 * @return string
	 */
    public static function to_utf8( string $what) {
        if (empty($what) && !is_numeric($what)) {return '';}
	 ...
	 */
    public static function tags_to_n( string $string,$replace_nobreak_space= false) {
